...
class ExecutionEnvironment:
    ...
    # merge_vault_envs_into and fetch_vault_envs were removed in Phase 0
    # auth redesign. Credentials now reach the SANDBOX JIT via
    # cookrew-beta → SPA → krewhub /credential-relay → SandboxHand.
    # The brain spawns with operator shell env only. hitl.request_access
    # is the only credential pathway.
