...
def create_gateway_app(
    ...
    When ``krewhub_client`` is provided, SpawnManager will stream
    structured events (tool calls, thinking, assistant replies)
    to krewhub during agent execution so cookrew can render them
    live via the SSE watch.
